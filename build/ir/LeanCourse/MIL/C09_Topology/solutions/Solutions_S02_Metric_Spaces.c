...
// Module: LeanCourse.MIL.C09_Topology.solutions.Solutions_S02_Metric_Spaces
...
LEAN_EXPORT lean_object* initialize_LeanCourse_MIL_C09__Topology_solutions_Solutions__S02__Metric__Spaces(uint8_t builtin, lean_object* w) {
lean_object * res;
