...
// Module: LeanCourse.MIL.C03_Logic.solutions.Solutions_S03_Negation
...
LEAN_EXPORT lean_object* initialize_LeanCourse_MIL_C03__Logic_solutions_Solutions__S03__Negation(uint8_t builtin, lean_object* w) {
lean_object * res;
