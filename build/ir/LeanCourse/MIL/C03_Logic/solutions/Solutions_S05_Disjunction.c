...
// Module: LeanCourse.MIL.C03_Logic.solutions.Solutions_S05_Disjunction
...
LEAN_EXPORT lean_object* initialize_LeanCourse_MIL_C03__Logic_solutions_Solutions__S05__Disjunction(uint8_t builtin, lean_object* w) {
lean_object * res;
