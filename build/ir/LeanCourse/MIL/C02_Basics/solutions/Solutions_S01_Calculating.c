...
// Module: LeanCourse.MIL.C02_Basics.solutions.Solutions_S01_Calculating
...
LEAN_EXPORT lean_object* initialize_LeanCourse_MIL_C02__Basics_solutions_Solutions__S01__Calculating(uint8_t builtin, lean_object* w) {
lean_object * res;
